...
export default function ShelterCrisis() {
  return (
    <section id="shelter" className="py-20 relative">
      {/* Background accent */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="overflow-x-auto">
            <div className="min-w-[600px]">
              {/* Header */}
              <div className="grid grid-cols-4 gap-4 p-4 bg-card border border-border rounded-t-xl text-sm font-medium text-muted-foreground">
                <div>Vendor</div>
                <div>Amount</div>
                <div>Issue</div>
                <div>Connection</div>
              ...
              {shelterCrisis.contracts.map((contract, index) => (
                <div
                  key={index}
                  className="grid grid-cols-4 gap-4 p-4 border-x border-b border-border last:rounded-b-xl hover:bg-card-hover transition-colors"
                >
        ...
        >
          <div className="p-6 rounded-xl bg-card border border-border">
            ...
            <div className="text-sm text-muted-foreground mb-1">Per Family Cost</div>
            <div className="text-xl font-bold text-white">{shelterCrisis.costs.perFamily}</div>
          </div>
          <div className="p-6 rounded-xl bg-card border border-border">
            <Building className="w-8 h-8 text-money mb-4" />
            <div className="text-sm text-muted-foreground mb-1">Communities Affected</div>
          ...
          <div className="p-6 rounded-xl bg-card border border-border">
            ...
            <div className="text-sm text-muted-foreground mb-1">National Guard (FY24)</div>
